...
public class PdfObject : IComparable<PdfObject>
	...
	internal	Double				ScaleFactor;		// scale factor from user unit of measure to points
	internal	ObjectType			Type;				// object type
	...
	internal PdfObject
		...
		if(Type != ObjectType.Dictionary) ContentsString = new StringBuilder();
	...
	////////////////////////////////////////////////////////////////////
	// Remove the most recent object that was added
	////////////////////////////////////////////////////////////////////

	internal void RemoveLastObject()
		{
		Document.ObjectArray.RemoveAt(Document.ObjectArray.Count - 1);
		return;
		}
	...
	internal void WriteObjectHeaderToPdfFile()
		{
		// not done yet
		if(FilePosition == 0)
			{
