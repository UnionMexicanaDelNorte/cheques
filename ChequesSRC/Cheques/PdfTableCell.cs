...
//			Parent.Contents.DrawRectangle(FrameLeft, Parent.RowBottomPosition, FrameWidth, Header ? Parent.HeaderHeight : Parent.RowHeight, PaintOp.Fill);
		...
		switch(Type)
			...
			case CellType.TextBox:
				...
				Parent.Contents.SaveGraphicsState();
				Parent.Contents.DrawText(LeftPos(TextBox.BoxWidth), ref YPos, ClientBottom - Parent.Epsilon, 0,
		...
		// cell has a web link
		if(WebLink != null) Parent.Page.AddWebLink(ClientLeft, ClientBottom, ClientRight, ClientTop, WebLink);
		return;
		}
