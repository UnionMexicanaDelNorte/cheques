...
public class PdfContents : PdfObject
	...
	public void SetLineWidth
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} w\n", ToPt(Width));
		return;
		}
	...
	public void SetMiterLimit
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} M\n", Round(MiterLimit));
		return;
		}
	...
	public void SetDashLine
		...
		// dash line
			...
			foreach(Double Value in DashArray) ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} ", ToPt(Value));
			ContentsString.AppendFormat(NFI.PeriodDecSep, "] {0} d\n", ToPt(DashPhase));
			}
		return;
		}
	...
	public void GrayLevelNonStroking
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} g\n", Round(GrayLevel));
		return;
		}
	...
	public void SetTransMatrix
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} {2} {3} {4} {5} cm\n", Round(a), Round(b), Round(c), Round(d), ToPt(e), ToPt(f));
		return;
		}
	...
	public void Translate
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "1 0 0 1 {0} {1} cm\n", ToPt(OriginX), ToPt(OriginY));
		return;
		}
	...
	public void Scale
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} 0 0 {0} 0 0 cm\n", Round(Scale));
		return;
		}
	...
	public void TranslateScale
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{2} 0 0 {2} {0} {1} cm\n", ToPt(OriginX), ToPt(OriginY), Round(Scale));
		return;
		}
	...
	public void TranslateScale
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{2} 0 0 {3} {0} {1} cm\n", ToPt(OriginX), ToPt(OriginY), Round(ScaleX), Round(ScaleY));
		return;
		}
	...
	public void TranslateScaleRotate
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{2} {3} {4} {2} {0} {1} cm\n",
	...
	public void TranslateScaleRotate
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{2} {3} {4} {5} {0} {1} cm\n",
	...
	public void DrawBezier
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} {2} {3} {4} {5} c\n",
	...
	public void DrawBezierNoP1
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} {2} {3} v\n", ToPt(X2), ToPt(Y2), ToPt(X3), ToPt(Y3));
		return;
		}
	...
	public void DrawBezierNoP2
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} {2} {3} y\n", ToPt(X1), ToPt(Y1), ToPt(X3), ToPt(Y3));
		return;
		}
	...
	public void DrawLine
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} m {2} {3} l S\n", ToPt(X1), ToPt(Y1), ToPt(X2), ToPt(Y2));
		return;
		}
	...
	public void DrawLine
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "q {0} w {1} {2} m {3} {4} l S Q\n", ToPt(LineWidth), ToPt(X1), ToPt(Y1), ToPt(X2), ToPt(Y2));
		return;
		}
	...
	public void SetTextPosition
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} Td\n", ToPt(PosX), ToPt(PosY));
		return;
		}
	...
	public void SetCharacterSpacing
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} Tc\n", ToPt(ExtraSpacing));
		return;
		}
	...
	public void SetWordSpacing
		...
		{
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} Tw\n", ToPt(Spacing));
		return;
		}
	...
	public Double DrawText
		...
		// draw text
		ContentsString.AppendFormat(NFI.PeriodDecSep, "{0} {1} Tf{2} Tj\n", Font.ResourceCode, Round(FontSize), Font.PdfText(Text));
	...
	public Double DrawText
		...
		// draw text
		ContentsString.AppendFormat(NFI.PeriodDecSep, "BT{0} {1} Tf {2} {3} Td[", Font.ResourceCode, Round(FontSize), ToPt(PosX), ToPt(PosY));
	...
	public void ClipText
		...
		// draw text
		ContentsString.AppendFormat(NFI.PeriodDecSep, "BT{0} {1} Tf {2} {3} Td 7 Tr{4}Tj ET\n",
			Font.ResourceCode, Round(FontSize), ToPt(PosX), ToPt(PosY), Font.PdfText(Text));
		return;
		}
	...
	public void DrawImage
		...
		// draw image
		ContentsString.AppendFormat(NFI.PeriodDecSep, "q {0} 0 0 {1} {2} {3} cm {4} Do Q\n",
	...
	public void DrawChart
		...
		PdfChart.SaveToPdfFile(DisposeChart);
