...
public class PdfDocument : IDisposable
	...
	/// </summary>
	public static readonly String RevisionNumber = "1.13.0";

	/// <summary>
	/// Library revision date
	/// </summary>
	public static readonly String RevisionDate = "2015/05/05";
	...
	internal static SizeD[] PaperTypeSize = new SizeD[]
      ...
      //  new SizeD(624, 312),	// cheque
        new SizeD(432, 288),	// cheque
		 new SizeD(632, 288),
		};
	...
	public void Dispose()
		{
		if(FileName != null && PdfFile != null) PdfFile.Close();
		return;
		}
	}
}
